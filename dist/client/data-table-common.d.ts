import { type StoresValues, type Writable } from 'svelte/store';
...
export declare function createEmptyDataTable<Column extends string, O>(meta: DataTableOffsetPaginationMeta<Column>, getParamsForSort: (column: Column) => URLSearchParams): Writable<StoresValues<OffsetDataTable<Column, O>>>;
export declare function createEmptyDataTable<Column extends string, O>(meta: DataTableCursorPaginationMeta<Column>, getParamsForSort: (column: Column) => URLSearchParams): Writable<StoresValues<CursorDataTable<Column, O>>>;
