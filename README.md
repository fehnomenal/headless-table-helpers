...
```sh
npm install -D 'github:fehnomenal/headless-table-helpers#semver:v3.1.0'
```

```sh
yarn install -D 'github:fehnomenal/headless-table-helpers#semver:v3.1.0'
```

```sh
pnpm install -D 'github:fehnomenal/headless-table-helpers#semver:v3.1.0'
```

```sh
bun add -D 'github:fehnomenal/headless-table-helpers#semver:v3.1.0'
```
